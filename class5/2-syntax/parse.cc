// Generated by Bisonc++ V5.02.00 on Sun, 18 Oct 2020 02:14:05 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {300, 4}, // 14: assignment (T_ID) ->  T_ID T_ASSIGN expression T_SEMICOLON
     {301, 5}, // 15: read (T_READ) ->  T_READ T_OPEN T_ID T_CLOSE T_SEMICOLON
     {302, 5}, // 16: write (T_WRITE) ->  T_WRITE T_OPEN expression T_CLOSE T_SEMICOLON
     {303, 5}, // 17: branch (T_IF) ->  T_IF expression T_THEN statements T_ENDIF
     {303, 7}, // 18: branch (T_IF) ->  T_IF expression T_THEN statements T_ELSE statements T_ENDIF
     {304, 5}, // 19: loop (T_WHILE) ->  T_WHILE expression T_DO statements T_DONE
     {304, 9}, // 20: loop (T_FOR) ->  T_FOR T_ID T_ASSIGN expression T_TO expression T_DO statements T_DONE
     ...
     {305, 2}, // 37: expression (T_INC) ->  expression T_INC
     {305, 2}, // 38: expression (T_DEC) ->  expression T_DEC
     {305, 2}, // 39: expression (T_INC) ->  T_INC expression
     {305, 2}, // 40: expression (T_DEC) ->  T_DEC expression
