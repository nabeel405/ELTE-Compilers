// Generated by Bisonc++ V5.02.00 on Wed, 04 Nov 2020 20:14:01 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {298, 2}, // 9: statement (T_SEMICOLON) ->  assignment T_SEMICOLON
     {298, 1}, // 10: statement ->  assignment
     {298, 2}, // 11: statement (T_SEMICOLON) ->  read T_SEMICOLON
     {298, 1}, // 12: statement ->  read
     {298, 2}, // 13: statement (T_SEMICOLON) ->  write T_SEMICOLON
     {298, 1}, // 14: statement ->  write
     {298, 1}, // 15: statement ->  branch
     {298, 1}, // 16: statement ->  loop
     {298, 2}, // 17: statement (T_SEMICOLON) ->  parallel T_SEMICOLON
     {298, 1}, // 18: statement ->  parallel
     {304, 6}, // 19: parallel (T_SOPEN) ->  T_SOPEN statement T_LINE T_LINE statements T_SCLOSE
     {299, 3}, // 20: assignment (T_ID) ->  T_ID T_ASSIGN expression
     {300, 4}, // 21: read (T_READ) ->  T_READ T_OPEN T_ID T_CLOSE
     {301, 4}, // 22: write (T_WRITE) ->  T_WRITE T_OPEN expression T_CLOSE
     ...
     {305, 1}, // 26: expression (T_NUM) ->  T_NUM
     {305, 1}, // 27: expression (T_TRUE) ->  T_TRUE
     {305, 1}, // 28: expression (T_FALSE) ->  T_FALSE
     {305, 1}, // 29: expression (T_ID) ->  T_ID
     {305, 3}, // 30: expression (T_ADD) ->  expression T_ADD expression
     {305, 3}, // 31: expression (T_SUB) ->  expression T_SUB expression
     {305, 3}, // 32: expression (T_MUL) ->  expression T_MUL expression
     {305, 3}, // 33: expression (T_DIV) ->  expression T_DIV expression
     {305, 3}, // 34: expression (T_MOD) ->  expression T_MOD expression
     {305, 3}, // 35: expression (T_LESS) ->  expression T_LESS expression
     {305, 3}, // 36: expression (T_GR) ->  expression T_GR expression
     {305, 3}, // 37: expression (T_EQ) ->  expression T_EQ expression
     {305, 3}, // 38: expression (T_AND) ->  expression T_AND expression
     {305, 3}, // 39: expression (T_OR) ->  expression T_OR expression
     {305, 2}, // 40: expression (T_NOT) ->  T_NOT expression
     {305, 3}, // 41: expression (T_OPEN) ->  T_OPEN expression T_CLOSE
     {306, 1}, // 42: program_$ ->  program
};
