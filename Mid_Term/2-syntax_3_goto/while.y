...
| 
T_BOOLEAN T_LABEL T_SEMICOLON
    {
    std::cout<<"declartion -> T_BOOLEAN T_LABEL T_SEMICOLON"<<std::endl;
    }
|
 T_INTEGER T_LABEL T_SEMICOLON
    {
    std::cout<<"declartion -> T_INTEGER T_LABEL T_SEMICOLON"<<std::endl;
    }
;
...
| goto
    {
    std::cout<<"statment-> goto"<< std::endl;
    }
|
 label 
 {
    std::cout<<"statment-> label"<<std::endl;
 }
;
goto:
    T_GOTO T_LABEL T_SEMICOLON
    {
        std::cout<<"goto -> T_GOTO T_LABEL T_SEMICOLON"<<std::endl;
    }
;
label:
    T_LABEL T_COLON
    {
    std::cout<<"label -> T_LABEL T_COLON "<<std::endl;
    }
    ;
assignment:
...
| T_LABEL
{
    std::cout<<"expression -> label"<<std::endl;
}
|
    T_ID
    {
