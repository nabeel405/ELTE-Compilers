...
|
    simultenous T_SEMICOLON
    {
    std::cout<<"statment->simultenous T_SEMICOLON"<<std::endl;
    }
;
simultenous:
        names T_ASSIGN values
    {
    std::cout<<"simultenous-> Names T_ASSIGN VALUES"<<std::endl;
    };
names:
    T_ID
{
    std::cout<<"names->T_ID"<<std::endl;
}
|
    T_ID T_COMMA names
    {
    std::cout<<"names->T_ID T_COMMA names"<<std::endl;
    }
;
values:
    expression
{
    std::cout<<"values->expression"<<std::endl;
}
|
    expression T_COMMA values
{
    std::cout<<"values->expression T_COMMA values"<<std::endl;
    }
;
assignment:
