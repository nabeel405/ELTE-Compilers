...
|
    ternary
    {
    std::cout<<"statment->ternary"<<std::endl;
    }
;

ternary:
    T_ID T_ASSIGN T_OPEN expression T_TERNARY expression T_COLON expression T_CLOSE T_SEMICOLON
{
    std::cout<<"ternary->T_ID T_ASSIGN T_OPEN expression T_TERNARY expression T_COLON expression T_CLOSE T_SEMICOLON"<<std::endl;
};
assignment:
