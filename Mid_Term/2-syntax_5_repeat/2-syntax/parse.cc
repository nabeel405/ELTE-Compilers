// Generated by Bisonc++ V5.02.00 on Wed, 04 Nov 2020 20:43:27 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {297, 1}, // 14: statement ->  repeat
     {303, 6}, // 15: repeat (T_REPEAT) ->  T_REPEAT statements T_UNTIL conditionals T_DONE T_SEMICOLON
     ...
     {305, 1}, // 22: expression (T_NUM) ->  T_NUM
     {305, 1}, // 23: expression (T_TRUE) ->  T_TRUE
     {305, 1}, // 24: expression (T_FALSE) ->  T_FALSE
     ...
     {305, 1}, // 31: expression ->  conditionals
     {305, 3}, // 32: expression (T_OPEN) ->  T_OPEN expression T_CLOSE
     {304, 3}, // 33: conditionals (T_LESS) ->  expression T_LESS expression
     {304, 3}, // 34: conditionals (T_GR) ->  expression T_GR expression
     {304, 3}, // 35: conditionals (T_EQ) ->  expression T_EQ expression
     {304, 3}, // 36: conditionals (T_AND) ->  expression T_AND expression
     {304, 3}, // 37: conditionals (T_OR) ->  expression T_OR expression
     {304, 2}, // 38: conditionals (T_NOT) ->  T_NOT expression
