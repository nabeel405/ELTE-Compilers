// Generated by Bisonc++ V5.02.00 on Wed, 28 Oct 2020 12:58:43 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {301, 5}, // 17: branch (T_IF) ->  T_IF expression T_BEGIN statements T_END
     {301, 9}, // 18: branch (T_IF) ->  T_IF expression T_BEGIN statements T_END T_ELSE T_BEGIN statements T_END
     {302, 5}, // 19: loop (T_WHILE) ->  T_WHILE expression T_BEGIN statements T_END
     {302, 6}, // 20: loop (T_REPEAT) ->  T_REPEAT statements T_UNTIL expression T_DONE T_SEMICOLON
     {303, 1}, // 21: expression (T_NUM) ->  T_NUM
     {303, 1}, // 22: expression (T_TRUE) ->  T_TRUE
     {303, 1}, // 23: expression (T_FALSE) ->  T_FALSE
     {303, 1}, // 24: expression (T_ID) ->  T_ID
     {303, 3}, // 25: expression (T_ADD) ->  expression T_ADD expression
     {303, 3}, // 26: expression (T_SUB) ->  expression T_SUB expression
     {303, 3}, // 27: expression (T_MUL) ->  expression T_MUL expression
     {303, 3}, // 28: expression (T_DIV) ->  expression T_DIV expression
     {303, 3}, // 29: expression (T_MOD) ->  expression T_MOD expression
     {303, 3}, // 30: expression (T_LESS) ->  expression T_LESS expression
     {303, 3}, // 31: expression (T_GR) ->  expression T_GR expression
     {303, 3}, // 32: expression (T_EQ) ->  expression T_EQ expression
     {303, 3}, // 33: expression (T_AND) ->  expression T_AND expression
     {303, 3}, // 34: expression (T_OR) ->  expression T_OR expression
     {303, 2}, // 35: expression (T_NOT) ->  T_NOT expression
     {303, 3}, // 36: expression (T_OPEN) ->  T_OPEN expression T_CLOSE
     {304, 1}, // 37: program_$ ->  program
};
