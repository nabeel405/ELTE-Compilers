...
|   
    T_LESS tuple T_GR T_ID T_SEMICOLON
    {
    std::cout<< "declaration -> tuple T_ID T_SEMICOLON" << std::endl;
    }
;
tupletype:
    T_INTEGER
...
|
    tupletype T_COMMA tuple
    {
        std::cout << "tuple -> type T_COMMA tuple"<<std::endl;
    }
;
statements:
    statement
...
|
  T_LESS tuple T_GR T_ID T_SEMICOLON
  {
    std::cout<<"declaration -> tuple T_ID T_SEMICOLLONN"<< std::endl;
  }
;
...
access_tuple:
    T_ID T_POINT T_NUM 
    {
        std::cout<<"acces_tuple -> T_ID T_POINT T_NUM "<< std::endl;
    }
;
assignment:
...
|
    access_tuple T_ASSIGN expression T_SEMICOLON
    {
    std::cout<<"assignment -> acces_tuple T_ASSIGN expression T_SEMICOLON "<<std::endl;
    }
;
...
| 
    T_READ T_OPEN access_tuple T_CLOSE T_SEMICOLON
    {
    std::cout <<"read -> T_READ T_OPEN access_tuple T_CLOSE T_SEMICOLON"<<std::endl;
    }
;
...
|
    access_tuple
    {
    std::cout << "expression -> acees_tuple"<<std::endl;
    }
;
