...
|
    T_INTEGER variables T_SEMICOLON
    {
        std::cout << "declartion-> T_INTEGER variables T_SEMICOLON"<<std::endl;
    }
|
    T_BOOLEAN variables T_SEMICOLON
    {
        std::cout << "declartion-> T_BOOLEAN variables T_SEMICOLON"<<std::endl;
    }
;
variables:
    T_ID
    {
        std::cout<<"variables -> T_ID"<<std::endl;
    }
|
    T_ID T_COMMA variables
    {
        std::cout << "variables -> T_ID T_COMMA variables"<<std::endl;
    }
;
