...
function_declaration:
    return_function
    {
        std::cout << "function_declaration -> return_function" << std::endl;
    }
|
    method
    {
        std::cout << "function_declaration -> method" << std::endl;
    }
;

return_function:
    T_FUNCTION type T_ID T_OPEN parameters T_CLOSE declarations T_BEGIN statements T_RETURN expression T_SEMICOLON T_END T_SEMICOLON
    {
        std::cout << "function_declaration -> T_FUNCTION type T_ID T_OPEN parameters T_CLOSE declarations T_BEGIN statements T_RETURN expression T_SEMICOLON T_END T_SEMICOLON" << std::endl;
    }
;

method:
    T_FUNCTION T_ID T_OPEN parameters T_CLOSE declarations T_BEGIN statements T_END T_SEMICOLON
    {
        std::cout << "function_declaration -> T_FUNCTION T_ID T_OPEN parameters T_CLOSE declarations T_BEGIN statements T_END T_SEMICOLON" << std::endl;
    }
;
...
type:
    T_INTEGER
    {
        std::cout << "type -> T_INTEGER";
    }
|
    T_BOOLEAN
    {
        std::cout << "type -> T_BOOLEAN";
    }
;
...
|
    function_call
    {
        std::cout << "statement -> function_call" << std::endl;
    }
;

function_call:
    T_ID T_OPEN expression T_CLOSE T_SEMICOLON
    {
        std::cout << "function_call -> T_ID T_OPEN expression T_CLOSE T_SEMICOLON" << std::endl;
    }
|
    T_ID T_OPEN T_ID T_OPEN expression T_CLOSE T_CLOSE T_SEMICOLON
    {
        std::cout << "function_call -> T_ID T_OPEN T_ID T_OPEN expression T_CLOSE T_CLOSE T_SEMICOLON" << std::endl;
    }
;
...
|
    function_call
    {
        std::cout << "expression -> function_call" << std::endl;
    }
;
