// Generated by Bisonc++ V5.02.00 on Mon, 19 Oct 2020 12:25:38 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {298, 3}, // 6: declaration (T_TIMETYPE) ->  T_TIMETYPE T_ID T_SEMICOLON
     ...
     {305, 1}, // 22: expression (T_TIME) ->  T_TIME
     {305, 4}, // 23: expression (T_HOUR) ->  T_HOUR T_OPEN T_ID T_CLOSE
     {305, 4}, // 24: expression (T_MINUTE) ->  T_MINUTE T_OPEN T_ID T_CLOSE
     {305, 1}, // 25: expression (T_TRUE) ->  T_TRUE
     {305, 1}, // 26: expression (T_FALSE) ->  T_FALSE
     {305, 1}, // 27: expression (T_ID) ->  T_ID
     {305, 3}, // 28: expression (T_ADD) ->  expression T_ADD expression
     {305, 3}, // 29: expression (T_SUB) ->  expression T_SUB expression
     {305, 3}, // 30: expression (T_MUL) ->  expression T_MUL expression
     {305, 3}, // 31: expression (T_DIV) ->  expression T_DIV expression
     {305, 3}, // 32: expression (T_MOD) ->  expression T_MOD expression
     {305, 3}, // 33: expression (T_LESS) ->  expression T_LESS expression
     {305, 3}, // 34: expression (T_GR) ->  expression T_GR expression
     {305, 3}, // 35: expression (T_EQ) ->  expression T_EQ expression
     {305, 3}, // 36: expression (T_AND) ->  expression T_AND expression
     {305, 3}, // 37: expression (T_OR) ->  expression T_OR expression
     {305, 2}, // 38: expression (T_NOT) ->  T_NOT expression
     {305, 3}, // 39: expression (T_OPEN) ->  T_OPEN expression T_CLOSE
     {306, 1}, // 40: program_$ ->  program
};
